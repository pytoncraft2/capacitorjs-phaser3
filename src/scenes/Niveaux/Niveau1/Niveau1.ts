...
export default class Niveau1 extends BaseNiveaux {
	...
	editorCreate(): void {
		...
		this.physics.add.overlap(groupe_allies.list.map((e) => (e as Entite).rectangle_zone_interaction), groupe_adversaires.list , this.toucheEntiteAdverse as any, this.verifToucheEntiteAdverse as any);
